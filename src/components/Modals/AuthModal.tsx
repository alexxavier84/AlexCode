import { type } from "os";
import { IoClose } from "../../../node_modules/react-icons/io5";
...
const AuthModal:React.FC<AuthModalProps> = () => {
    ...
    return (
        <>
            ...
            <div className="w-full sm:w-[450px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex justyfy-center items-center">
                <div className="relative w-full h-full mx-auto flex items-center justify-center">
                    <div className="bg-white rounded-lg shadow relative w-full bg-gradient-to-b from-brand-orange to-slate-900 mx-6">
                        <div className="flex justify-end p-2">
                            ...
                            hover:bg-gray-800 hover:text-white text-white" onClick={closeModal}>
